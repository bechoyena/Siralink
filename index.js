...
// ==========================================
// 🛍 3. የተሟላ የእቃዎች መጋዘን (PRODUCTS DATA)
// ==========================================
const products = [
  {
    id: 1,
  ...
  {
    id: 3,
    name: 'የወንዶች ስፖርት ጫማ (Sneakers)',
    price: 2800,
    description: 'ለረጅም መንገድ እና ለስፖርት የሚሆን ምቹ ጫማ።',
    category: 'shoes',
...
// ==========================================
// 🛍 5. የሱቆች ክፍል (E-COMMERCE RESPONSE)
// ==========================================
...
bot.action(/^get_prod_(.+)$/, async (ctx) => {
  ...
  // እቃዎቹን አይቶ ሲጨርስ ወደ ዋናው ማውጫ መመለሻ በተን ከስር መላክ
  await ctx.reply('ሌላ እቃ ማየት ይፈልጋሉ?', Markup.inlineKeyboard([backToMain]));
});
...
bot.action('sell_instruction', (ctx) => {
  return ctx.reply('📤 የራስዎን ያገለገለ እቃ ለመሸጥ በቀጥታ በቦቱ ላይ /sell ብለው ይጻፉ።', Markup.inlineKeyboard([backToMain]));
});
...
// ==========================================
// 🚀 9. አስተማማኝ ማስነሻ (Clean Long Polling)
// ==========================================
bot.launch({
  polling: {
  ...
  console.log('Siralink Bot 100% ሙሉ ሆኖ በንቃት ተነስቷል! 🚀');
}).catch((err) => {
  console.error(err);
});
